Automation Ownership Act — A Governance Framework for Labor in the Age of Robotics
Status: Thought Experiment / Open for Critique

What This Is
This repository contains a consolidated governance framework for rethinking who owns industrial automation — and who should.
...
The framework is built around a few core mechanisms:
...
Governance voice (codetermination, sectoral bargaining)
...
framework.md — The complete consolidated framework (core thesis + all mechanisms)

open-questions.md — Ten open questions the framework explicitly acknowledges it cannot fully answer yet
...
The capital flight problem — Is the data-provenance advantage enough to offset Wage A+B costs? If not, what additional layer is needed?

The cross-trade equalization rate — What's the right surplus-sharing ratio that preserves skill-mastery incentives?

The enforcement layer — What stops informal circumvention (power-of-attorney, hidden capital interests) in practice?

The demand-side concentration gap — Is an antitrust-style cap on regional robot supply sourcing necessary?

The manufacturer buyback loophole — What stops an operating company from acquiring a nominal "manufacturer" entity solely to conduct retirement buybacks?
